...
<article class="v3-activity-card" data-submission-status="pending"><div class="v3-activity-head"><span class="v3-state amber">待审核</span><span class="v3-state outline">2026-09-24</span></div><strong>校园图书角的一天 [演示数据]</strong><p class="v3-body-copy">校园新闻 · 稿件已进入编辑审核队列。</p></article>
