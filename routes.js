...
'4':[['资格申请','J07'],['我要在线投稿','J02'],['在线投稿','J02'],['投稿进度','J03'],['作品档案','J04'],['荣誉证书','J06'],['小记者风采','J05'],['阅读全文','J01']],
'5':[['发布创作','Y04'],['我的发布','Y05']],
'6':[['进入直播','C02'],['观看回放','C03'],['课程详情','C01']],
'7':[['小小发明家','K03'],['一起来寻宝','K02'],['我的作品','K04'],['优秀成果','K01'],['科普问答','K05']],
'8':[['进入服务','V01']], '9':[['精选版面','N01'],['官方订阅','N02']],
'10':[['我的收藏','G03'],['我的投稿','G05'],['已确认活动','G04'],['个人资料','G06'],['小记者资格','J07']], '11':[], '12':[],
'J01':[['在线投稿','J02'],['作品档案','J04'],['荣誉证书','J06'],['小记者风采','J05']],
'J02':[['投稿进度','J03'],['返回小记者工作台','4']], 'J03':[['查看见报文章','J01'],['荣誉证书','J06'],['撰写新采写文稿','J02']],
'J04':[['作品详情','J01'],['录用进度','J03'],['直达修改','J03'],['发起新稿件投稿','J02']], 'J05':[['阅读全文','J01'],['荣誉证书','J06'],['投稿成为风采小记者','J02']], 'J06':[['返回小记者','4']], 'J07':[['返回小记者','4']],
...
fetch((/^[A-Z]/.test(id)?'../':'')+'stitch-pages.json').then(r=>r.json()).then(pages=>{if(document.getElementById('ep-page-menu'))return;const menu=document.createElement('details');menu.id='ep-page-menu';const title=document.createElement('summary');title.textContent='页面导航';menu.append(title);const box=document.createElement('div');const back=document.createElement('button');back.textContent='返回'+({R:'读书会',S:'少年派',J:'小记者',Y:'教育看板',C:'公益课堂',K:'科学港',V:'填志愿',N:'订报刊',G:'我的'}[group]||'首页');back.onclick=()=>go(groups[group]||1);box.append(back);for(const [r,name] of Object.entries(pages)){if(r[0]===group||r[0]==='G'){const b=document.createElement('button');b.textContent=name;b.onclick=()=>go(r);if(r===id)b.disabled=true;box.append(b)}}menu.append(box);document.body.append(menu)}).catch(()=>{});
